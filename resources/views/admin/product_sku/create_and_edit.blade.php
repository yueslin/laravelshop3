                    ...
                    <div class="form-group myshow">
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    ...
                                    <input type="text" value="{{$v->pivot->val}}" data-id="{{$v->id}}" class="form-control price product_attributes" placeholder="输入 {{$v->name}}">
                                </div>
                            </div>
                    </div>
                        @endforeach
                ...
                success:function (data) {
                    if (data.length == 0) {
                        ...
                        for (var i = 0; i < data.length; i++) {
                            el += '<div class="form-group myshow">' +
                                '<label for="price" class="col-sm-2  control-label">'+data[i].name+
                                '<i style="color:red;"> *</i>' +
                                ...
                                '</span>' +
                                '<input type="text" value="" data-id="'+data[i].id+'" class="form-control price product_attributes" placeholder="输入'+data[i].name+'"></div></div></div>';
